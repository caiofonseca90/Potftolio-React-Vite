...
const Contact = () => {
  ...
  return (
    <section id="contacts" className="max-w-[40rem] min-w-[25rem] lg:max-w-[80%] lg:min-w-[45rem] text-start mt-[5rem] m-auto flex flex-col mb-[5rem]">
      ...
      <Flip top cascade text duration='2000'>
      <div className="p-3">
    ...
    <form className="flex flex-col justify-center">
      <Fade cascade duration='2600'>
        ...
        <Bounce bottom duration='2650'>
          <span className="h-[.45px] rounded-full w-full bg-purple-300 "></span>
        </Bounce>
      
        <Flip right duration='2000'delay='1500' >
          <button className="bg-purple-400 rounded-full text-center text-[1.2rem] md:text-2xl font-bold 
