...
const Projects = () => {
  return (
    <section id="projects" className="pt-28 max-w-[50rem] min-w-[15rem] lg:max-w-[80%] lg:min-w-[45rem] textstart m-auto flex flex-col">
        ...
        <div className="md:grid md:grid-rows-3 md:grid-cols-2 md:gap-1 flex flex-col justify-center gap-3 md:max-w-[1200px] ">
            ...
            <div className="col-span-2 bg-transparent p-1 ">
                <div className="flex flex-col justify-center overflow-hidden rounded-2xl">
                    <img className="cursor-pointer hover:scale-105 opacity-60 hover:opacity-100 hover:transition-all delay-75 bg-cover bg-no-repeat h-[310px] md:max-w-full md:h-[410px] relative" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSJNa6chsV_gCPqNdiRNVxu2sa3y0J2H45fc6A0p9oN&s" alt="prj1" />
                </div>
            ...
            <div className=" bg-transparent p-1 ">
                <div className="flex flex-col justify-center overflow-hidden rounded-2xl">
                    <img className=" cursor-pointer  bg-cover hover:scale-105 opacity-60 hover:opacity-100 hover:transition-all delay-75 bg-no-repeat h-[310px]  md:h-[420px] relative" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSJNa6chsV_gCPqNdiRNVxu2sa3y0J2H45fc6A0p9oN&s" alt="prj1" />
                </div>
                <div className="flex flex-row bg-transparent text-neutral-300 justify-around w-[150px] relative top-[-80px] pl-14">
                    <span className="p-4 rounded-full m-1 bg-neutral-800-400 text-purple-400 font-bold shadow-2xl cursor-pointer ">GitHub</span>
                    <span className="p-4 rounded-full m-1 bg-neutral-800-400 text-purple-400 font-bold shadow-2xl cursor-pointer ">Deploy</span>
